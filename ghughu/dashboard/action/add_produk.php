...
$query = "
    INSERT INTO produk
    (nama_produk, rasa, ukuran, harga, deskripsi, varian, foto)
    VALUES
    ('{$nama_produk}', '{$rasa}', '{$ukuran}', '{$harga}', '{$deskripsi}', '{$varian}', '{$filepath}');";
...
if ( $insert == false ) {
    echo "Error dalam menambahkan data <a href='dashboard/tables-data.php'>Kembali</a>";
} 
else {
